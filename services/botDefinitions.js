module.exports = {
  ...
  meeting: {
    ...
    fields: [
      ...
      { name: 'duration', type: 'number', question: '⏱️ Duration in minutes?', required: true },
  ...
  travel: {
    ...
    fields: [
      ...
      { name: 'departureDate', type: 'datetime', question: '✈️ Departure date & time?', required: true },
  ...
  news: {
    ...
    fields: [
      ...
      { name: 'category', type: 'text', question: '🏷️ Category?', required: false },
  ...
  market: {
    ...
    fields: [
      ...
      { name: 'period', type: 'text', question: '⏱️ Period?', required: false }
    ]
  },
